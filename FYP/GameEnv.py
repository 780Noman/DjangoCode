...
class Car:
    def __init__(self, x, y):
        ...
        self.original_image = pygame.image.load("C:\\Users\\noman\\DjangoCode\\FYP\\car.png").convert()
...
class RacingEnv:
    ...
    def __init__(self):
        ...
        self.back_image = pygame.image.load("C:\\Users\\noman\\DjangoCode\\FYP\\track.png").convert()
